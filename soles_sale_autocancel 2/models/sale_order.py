...
class SaleOrder(models.Model):
    ...
    def _cron_autocancel_ordenes(self):
        ...
        Unifica los dos enfoques previos (soles_sale_autocancel y
        sale_auto_cancel_unbilled): usa invoice_status para detectar
        "nada que facturar" (más robusto que invoice_ids vacío), deja
        nota en el chatter de cada pedido, y es tolerante a errores por
        pedido individual. Toda la parametrización vive en
