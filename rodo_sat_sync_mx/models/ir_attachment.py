...
class IrAttachment(models.Model):
    ...
    payment_method = fields.Char("Metodo de Pago")
    payment_form = fields.Char("Forma de Pago")
    moneda = fields.Char("Moneda")
    TotalImpuestosRetenidos = fields.Float("Total Impuestos Retenidos")
    TotalImpuestosTrasladados = fields.Float("Total Impuestos Trasladados")
    ...
    def _read_group_allowed_fields(self):
        return super(IrAttachment, self)._read_group_allowed_fields() + ['creado_en_odoo', 'date_cfdi',
                                                                         'nombre_tercero', 'serie_folio','payment_method','payment_form','moneda','create_date',
                                                                         'TotalImpuestosRetenidos','TotalImpuestosTrasladados','rfc_tercero', 'cfdi_uuid', 'cfdi_type',
                                                                         'cfdi_total']
        ...
        if ctx.get('is_fiel_attachment'):
            ...
            if datas:
                ...
                vals.update({
                    ...
                    'payment_method': tree.get('MetodoPago', tree.get('metodopago')),
                    'payment_form': tree.get('FormaPago', tree.get('formapago')),
                    'moneda': tree.get('FormaPago', tree.get('Moneda')),
                    'TotalImpuestosRetenidos': tree.get('TotalImpuestosRetenidos', tree.get('totalimpuestosretenidos')),
                    'TotalImpuestosTrasladados': tree.get('TotalImpuestosTrasladados', tree.get('totalimpuestostrasladados')),
                    'serie_folio': str(tree.get('Serie', tree.get('serie'))) + str(tree.get('Folio', tree.get('folio')))
                })
